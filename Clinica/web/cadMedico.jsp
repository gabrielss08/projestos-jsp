<%-- 
    Document   : cadMedico
    Created on : 30 de set. de 2023, 14:43:07
    Author     : Fatec 3D
--%>
    ...
    <body>
        <h1>Cadastro Medico</h1>
         ...
         <form action="" method="post"> 
                    ...
                    <select class="form-select" name="txtEsp">
                        <option value="0">Escolha uma Especialidade</option>
                        <%
                            try{
        ...
        <%
           if(request.getParameter("btnSalvar")!=null){ 
               ...
               try{ 
                        st = new Conexao().conectar().createStatement(); 
                        st.executeUpdate("insert into tbmedico(nomeMedico,telMedico, celMedico) values('"+nome+"','"+tel+"','"+cel+"')");     
